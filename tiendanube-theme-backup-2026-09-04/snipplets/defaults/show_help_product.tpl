...
<div id="single-product" class="js-has-new-shipping js-product-detail js-product-container js-shipping-calculator-container pb-4 pt-md-4 pb-md-3" data-variants="{{product.variants_object | json_encode }}" data-store="product-detail">
    <div class="container mt-4 mt-md-0 mb-3 pt-md-1">
        <div class="row">
            ...
            <div class="col">
                <div class="pt-md-3">
                    <section class="page-header text-center text-md-left">
                        ...
                        <h1 class="h2 mb-2">{{ "Producto de ejemplo" | translate }}</h1>
                    </section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 pr-0 pr-md-3">
                <h2 class="section-title mb-4 text-center">{{ "Productos relacionados" | translate }}</h2>
                ...
                <div class="mt-4 text-center">
                    <div class="js-swiper-related-prev-demo swiper-button-prev svg-icon-text">
                        <svg class="icon-inline icon-lg icon-flip-horizontal"><use xlink:href="#arrow-long"/></svg>
                    </div>
                    <div class="js-swiper-related-next-demo swiper-button-next svg-icon-text">
                        <svg class="icon-inline icon-lg"><use xlink:href="#arrow-long"/></svg>
                    </div>
                </div>
            </div>
